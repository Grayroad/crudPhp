        ...
        <table class="table">
            ...
            <tbody>
                <?php while ($dados_usuarios = mysqli_fetch_array($resultado_id)) { ?>
                    <tr>
                        <th scope="row"><?= $dados_usuarios["id_usuario"] ?></th>
                        <td><?= $dados_usuarios["ds_usuario"] ?></td>
                        <td><?= $dados_usuarios["ds_email"] ?></td>
                        <td title="<?= $dados_usuarios["nm_senha"] ?>">****</td>
                        <td class="text-center"><a class="btn btn-sm btn-info" href="cadastrar_usuario.php?id=<?= $dados_usuarios["id_usuario"] ?>&acao=editar">Editar</a>
                        <a class="btn btn-sm btn-danger" href="cadastrar_usuario.php?id=<?= $dados_usuarios["id_usuario"] ?>&acao=excluir">Excluir</a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
